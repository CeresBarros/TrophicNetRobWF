...
[Zenodo](https://zenodo.org/doi/10.5281/zenodo.13334864).

## Study area

In Dansereau et al. (in prep.) trophic networks were calculated across
European countries, Turkey, Georgia and European Russia, under baseline
...
```{r, fig.cap = "Full study area in blue, with (removed) lakes shown in grey. Subset study area in black."}
...
```{r, echo = FALSE, fig.cap = "GlobCover land-cover classes with largest areas per 10 Km pixel in study area."}
...
-   IUCN extinctions - A targeted extinctions scenario, where we
...
[^1]: Land-cover/habitat projections were obtained from GLOBIO v3.5 runs
based on land-cover data for 2000.
